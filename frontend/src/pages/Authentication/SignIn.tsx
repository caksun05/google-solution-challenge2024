            ...
            <div className="h-full flex flex-wrap items-center">
                <div className="w-full xl:w-1/2">
                    <div className="w-full p-10.5 sm:px-12.5 xl:px-17.5">
                        ...
                        <div className="flex mt-5 items-center justify-center gap-2">
                            <span className="text-black dark:text-white">Tidak punya akun?</span>
                ...
                <div className="hidden w-full h-full xl:block xl:w-1/2 bg-color-white bg-green">
                    <div className="py-17.5 px-26 text-center">
                        <Link className="flex flex-wrap items-center justify-center mb-5.5" to="/">
                            <img className="w-20 dark:block" src={Logo} alt="Logo" />
                            <h1 className="text-white font-bold text-4xl ml-5">Cak Takim</h1>
                        </Link>
