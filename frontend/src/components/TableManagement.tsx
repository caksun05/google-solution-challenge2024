                  ...
                  <tr key={id}>
                    ...
                    <td className="border-b justify-center items-center border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:px-8 xl:py-6">
                      <div className="flex items-center space-x-3.5">
                        <button className="hover:text-primary" onClick={() => handleOpenDocument(items.pdf_path)}>
                          <svg
                        ...
                        <button className="hover:text-primary" onClick={() => window.open(items.pdf_path, "_blank")}>
                          <svg 
                            className="fill-current"
                            width="18"
                            height="18"
                        ...
                        <button className="hover:text-danger" onClick={() => handleDeleteDocument(items.id, items.filename)}>
                          <svg
                              className="fill-current"
                              width="18"
                              height="18"
