          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/data-response"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-greendark dark:hover:bg-meta-4 ${pathname.includes('data-response') && 'bg-greendark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
